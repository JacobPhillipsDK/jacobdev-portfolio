...
const experiences: education[] = [
  {
    ...
    period: "2022 - 2024",
    higlighted_skills: ["User Experience", "User Interface", "HCI", "Python", "FastAPI", "Machine Learning", "A* Algorithm", "Image Recognition", "Pathfinding", "Full Stack Development"],
      ...
      <Card className="relative z-10 transition-colors duration-300 hover:bg-muted/50">
        <CardContent className="p-6">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            {experience.higlighted_skills.map(
              (
                skill:
                  | boolean
                  | React.ReactElement<
        ...
        <div className="relative">
          ...
          <div className="relative space-y-12">
            {experiences.map((experience, index) => (
              <ClientSideAnimation key={experience.school_name}>
