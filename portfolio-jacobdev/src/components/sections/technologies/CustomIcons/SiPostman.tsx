...
const SiPostman: IconType = React.forwardRef<SVGSVGElement, SiPostmanProps>(function SiPostman({
                                                                                             title = 'SiPostman',
                                                                                             color = 'currentColor',
                                                                                             size = 24,
                                                                                             ...others
    ...
    return (
        ...
        >
            ...
            <style>{`.C{fill:#fafafa}.D{fill:#27272a}`}</style>
            ...
            <path
                ...
                className="C"/>
            <path d="M50.047 12.974l-4.56 4.533 3.627 3.627a5.52 5.52 0 0 0 1.013-.747c1.976-2.1 1.94-5.368-.08-7.413z"
                  className="D"/>
            <path
            ...
            <path
                ...
                className="C"/>
            <path d="M12.287 49.214l2.667-2.667 4.107 4.107-6.533-.453c-.23-.017-.425-.18-.48-.406s.042-.46.24-.58z"
                  className="D"/>
            <path
