      ...
      >
        <div className="flex h-16 items-center justify-between px-4 md:px-6">
          <div className="flex w-full justify-between">
            <Link href="/">
            <span className="flex items-center justify-center text-md font-semibold transition-transform hover:translate-x-1 hover:translate-y-1">
              {meta.author.name}
            </span>
            </Link>
              ...
              <nav className="flex items-center gap-4">
                <div className="flex items-center gap-4 lg:gap-6">
                  {links.slice(0, linkLimit).map(({ title, href }, index) => (
                      ...
                      >
                    <span className="flex items-center text-sm font-medium underline-offset-4 hover:underline">
                      {title}
                    </span>
                      </Link>
                  ))}
