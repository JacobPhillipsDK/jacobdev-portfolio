...
type SiJavaProps = React.ComponentPropsWithoutRef<'svg'> & {
    /**
...
const SiJava: IconType = React.forwardRef<SVGSVGElement, SiJavaProps>(function SiPytorch({
                                                                                             title = 'SiJava',
                                                                                             color = 'currentColor',
                                                                                             size = 24,
                                                                                             ...others
...
export {SiJava as default, defaultColor};
