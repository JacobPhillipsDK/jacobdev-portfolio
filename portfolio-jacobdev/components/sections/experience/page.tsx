...
const experiences: Experience[] = [
  {
    ...
    period: "January 2025 - ",
    description: `• Designed and spearheaded the MVP development of an alternative healthcare platform to help people discover and search for treatments.
...
• Mentored an intern, providing guidance on frontend development, solution design, technical best practices, and professional growth.`,
    skills: ["React", "Next.js", "Tailwind CSS", "Figma", "UI/UX", "Agile", "Scrum", "Firebase", "PostgreSQL", "ShadcnUI/Radix UI", "Python"],
    type_of_job: "Freelance",
    key: 1
  },
  {
    company: "Ad Fontes Society",
    ...
    description: "Conducted initial design, UX, and UI processes, and translated Figma designs into a landing page",
